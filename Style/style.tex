...
\@ifpackageloaded{babel}{%
    \addto\captionsitalian{\renewcommand{\chaptername}{Test}}%
}{%
    \renewcommand{\chaptername}{Test}%
}
\makeatother

\newcommand{\NotionDivider}{\par\vspace{1em}\noindent{\color{lightgray}\rule{\textwidth}{0.5pt}}\vspace{1em}}
...
\newtheorem{exerciseT}[dummyNOT]{Esercizio}
...
\newenvironment{prb}{\begin{hBox}\begin{problemT}}{\end{problemT}\end{hBox}}
